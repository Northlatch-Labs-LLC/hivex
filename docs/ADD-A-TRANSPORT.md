# Add a Transport to hivebot

This guide walks you through wiring a new external integration (Slack, Discord,
WhatsApp, Hermes, …) into hivebot as a typed transport adapter. The whole process
takes about 30 minutes once you have read this page.

## What is a transport?

A transport bridges an external messaging service with the hivebot office broker.
Three scopes exist:
...
```go
import "errors"
import "github.com/Northlatch-Labs-LLC/hivex/internal/team/transport"
