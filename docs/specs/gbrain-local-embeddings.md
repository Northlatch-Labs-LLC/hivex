...
Today, giving the wiki context layer semantic retrieval means handing hivebot an
...
- Its default is `anthropic:claude-haiku-4-5`, and hivebot's `gbrainEnv()` already
