...
- Fresh scratch runtime home (HIVEX_RUNTIME_HOME isolation), source build of the branch, dev ports 79xx (never 7890/7891), real claude-code provider, real LLM turns.
