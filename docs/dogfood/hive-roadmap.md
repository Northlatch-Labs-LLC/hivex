...
- Preserve local-first behavior. Hive context, integration events, and notebook
...
5. Seed hivebot-on-hivebot project context into local wiki/notebook fixtures.
