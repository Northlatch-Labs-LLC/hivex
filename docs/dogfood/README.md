# hivebot Dogfood Fixtures

These markdown files are seed context for bots working on hivebot itself. They
...
- [`hivex-roadmap.md`](hivex-roadmap.md) - near-term product and architecture
  themes.
...
- [`architecture-decisions.md`](architecture-decisions.md) - current decisions
  bots should treat as durable unless superseded.

Keep fixture facts sourced. If a future fixture mixes local wiki facts, Hive
context, integration signals, human notes, and bot notebook entries, each item
