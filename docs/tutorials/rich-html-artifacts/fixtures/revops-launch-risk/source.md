...
The useful artifact should let the operator compare owner load, risk severity, and mitigation options on one screen. It should also export a short prompt that can be pasted back into hivebot to assign the next work items.
