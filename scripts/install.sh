...
REPO="Northlatch-Labs-LLC/hivex"
BINARY="hivex"
...
#   HIVEX_INSTALL_URL_OVERRIDE   — skip resolution; download a specific tarball.
#                                  Cheap sanity check against a snapshot build.
#   HIVEX_INSTALL_REPO_BASE_URL  — override the GitHub base URL only. Still
...
REPO_BASE_URL="${HIVEX_INSTALL_REPO_BASE_URL:-https://github.com/${REPO}}"
URL="${HIVEX_INSTALL_URL_OVERRIDE:-}"
if [ -n "$URL" ]; then
  VERSION="${HIVEX_INSTALL_VERSION_OVERRIDE:-snapshot}"
