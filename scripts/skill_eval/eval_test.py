...
class TestDevHome(unittest.TestCase):
    ...
    def test_plain_home_appends_suffix(self) -> None:
        ...
        self.assertEqual(result, "/Users/testuser/.hivex-dev-home")

    def test_already_dev_home_is_idempotent(self) -> None:
        """When HOME already ends with /.hivex-dev-home, no doubling occurs."""
        os.environ["HOME"] = "/Users/testuser/.hivex-dev-home"
        result = skill_eval._dev_home()
        self.assertEqual(result, "/Users/testuser/.hivex-dev-home")
    ...
    def test_apply_home_isolation_sets_env(self) -> None:
        ...
        self.assertEqual(result, "/Users/testuser/.hivex-dev-home")
        self.assertEqual(os.environ["HOME"], "/Users/testuser/.hivex-dev-home")
