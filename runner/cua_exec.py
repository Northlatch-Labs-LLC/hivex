...
MODEL = os.environ.get("HIVEX_CUA_PLANNER_MODEL", "gpt-4o")
MAX_STEPS = int(os.environ.get("HIVEX_CUA_MAX_STEPS", "15"))
...
MAX_ELEMENTS = int(os.environ.get("HIVEX_CUA_MAX_ELEMENTS", "60"))
AX_MAX_ELEMENTS = int(os.environ.get("HIVEX_CUA_AX_MAX_ELEMENTS", "200"))
