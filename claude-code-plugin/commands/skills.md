...
**"sync" -> sync all skills to local .hive/ folder:**
Use `sync_skills`. This downloads all skills as .md files to .hive/skills/ for fast local access by any AI bot.
...
Use `read_skill` with the slug. Reads from .hive/skills/ first, falls back to API.
