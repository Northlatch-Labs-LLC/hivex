// Package openclaw implements the hivebot side of the OpenClaw gateway bridge:
...
// RequestFrame is a hivebot→OpenClaw gateway request.
...
// ResponseFrame is a gateway→hivebot response to a request.
...
// EventFrame is a gateway→hivebot push event.
