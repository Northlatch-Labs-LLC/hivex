...
const (
	...
	// HIVEX_<KIND>_BASE_URL / HIVEX_<KIND>_MODEL.
	KindMLXLM  = "mlx-lm"
	KindOllama = "ollama"
	KindExo    = "exo"
)
...
// shapes:
//
//   - FOREIGN bots (Kind == KindSlack): bots running outside hivebot, bridged
//     through the membrane; inbound posts from UserID are ALLOWED.
//   - SPAWNED bots (Kind != KindSlack, BotTokenEnv != ""): real office
//     bots on hivebot's own runtime that carry their own Slack app identity;
