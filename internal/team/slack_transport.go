...
type SlackTransport struct {
	...
	// office bots never present as separate Slack actors — hivebot is one bot
...
// OUR bot becomes "@<lead>" (tagging the hivex bot is how a Slack human talks
...
func (t *SlackTransport) FormatOutbound(msg channelMessage) (transport.Outbound, bool) {
	...
	// or came from another surface (web/API), where hivebot speaking AS that human
...
// users should see. hivebot presents as ONE coordinating bot in Slack: internal
...
// actually pinged; the office LEAD becomes the bot's own Slack name (hivebot is
