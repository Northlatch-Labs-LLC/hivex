...
//
// Override with HIVEX_SELF_HEAL_MAX_ACTIVE_PER_AGENT (>0) for installs with
// taller per-bot repair lanes.
const defaultMaxActiveSelfHealsPerBot = 3

var maxActiveSelfHealsPerBot = clampSelfHealCap(envIntDefault("HIVEX_SELF_HEAL_MAX_ACTIVE_PER_AGENT", defaultMaxActiveSelfHealsPerBot))
