...
//     these — an app whose bot rewrote hivex-bridge.ts still publishes with the
...
import (
	...
	"github.com/Northlatch-Labs-LLC/hivex/templates"
)
...
var customAppProtectedFiles = map[string]string{
	"src/hivex-bridge.ts":    "app-scaffold/src/hivex-bridge.ts",
	"src/hivex-inspector.ts": "app-scaffold/src/hivex-inspector.ts",
...
func snapshotAppSource(srcRoot string) (restore func() error, cleanup func(), err error) {
	snapDir, err := os.MkdirTemp("", "hivex-app-src-*")
	if err != nil {
