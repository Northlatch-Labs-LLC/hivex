...
//	2. entities/<entity> --hivex_fact_of--> atoms/<id>         (ListFactsForEntity)
...
const gbrainLinkFact = "hivex_fact_of"
...
func (s *gbrainFactStore) ensureEntityPage(ctx context.Context, slug string) error {
	...
	fm := map[string]string{"type": "concept", "hivex_slug": slug}
