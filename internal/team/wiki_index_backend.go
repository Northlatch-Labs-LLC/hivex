...
//
//   - HIVEX_WIKI_BACKEND unset  → try gbrain; on failure log a WARNING and fall
...
//   - HIVEX_WIKI_BACKEND=gbrain → gbrain or nothing. An operator who asked for
...
//   - HIVEX_WIKI_BACKEND=memory → the previous in-memory behaviour, no gbrain.
//
...
const WikiBackendEnv = "HIVEX_WIKI_BACKEND"
...
// HIVEX_WIKI_BACKEND=gbrain explicitly, which is what the live contract tests
