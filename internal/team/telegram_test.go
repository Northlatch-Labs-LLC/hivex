...
func TestFormatTelegramOutbound(t *testing.T) {
	...
	// Automation message
	autoMsg := channelMessage{From: "hive", Kind: "automation", Source: "github", Content: "PR #42 merged"}
	...
	autoMsg2 := channelMessage{From: "hive", Kind: "automation", Source: "gh", SourceLabel: "GitHub Actions", Content: "Build passed"}
