...
const (
	...
	// Opt-in via HIVEX_ENTITY_SYNTHESIS_MODE=demand.
	SynthesisModeDemand
)
...
const (
	relatedSentinelStart = "<!-- hivex:related:start -->"
	relatedSentinelEnd   = "<!-- hivex:related:end -->"
)
