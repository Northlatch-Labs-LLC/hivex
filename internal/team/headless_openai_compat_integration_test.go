...
//     hivex broker would expose (using mcp.AddTool with a typed input
//     struct).
...
// against the actual `hivex mcp-team` subprocess — minus the subprocess
...
func TestOpenAICompatBridge_E2E(t *testing.T) {
	...
	mcp.AddTool(server, &mcp.Tool{
		...
		Description: "Post a message to a hivex broker channel as the bot.",
