...
const entityArticleMarker = "<!-- hivex:entity-article"
...
const (
	entityProseSentinelStart   = "<!-- hivex:entity-prose:start -->"
	entityProseSentinelEnd     = "<!-- hivex:entity-prose:end -->"
	entityArticleSentinelStart = "<!-- hivex:entity-article:start -->"
	entityArticleSentinelEnd   = "<!-- hivex:entity-article:end -->"
)
