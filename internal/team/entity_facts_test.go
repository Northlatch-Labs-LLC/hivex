...
func TestFactLog_DeterministicID_Golden(t *testing.T) {
	...
	cases := []struct {
		...
		{"ascii", EntityKindPeople, "sarah", "CEO of Acme", "pm", "f647be65b2bd1186"},
		{"empty fields", EntityKindPeople, "", "", "", "720ab0937e59751f"},
		{"embedded NUL", EntityKindPeople, "slug", "a\x00b", "c", "749d95a142c7be12"},
		{"multi-byte UTF-8", EntityKindCompanies, "acme", "café", "agent", "09b729b65402e940"},
	}
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
