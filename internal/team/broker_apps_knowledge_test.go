...
func TestKnowledgePageGBrainRoundTrip(t *testing.T) {
	...
	if !strings.Contains(content, "hivex-app-d50e34194a87a5ed") {
...
func TestAppKnowledgeSlugAndTag(t *testing.T) {
	if got := appKnowledgeScopeTag("app_abc123"); got != "hivex-app-abc123" {
...
func TestDecodeKnowledgePageRejectsGarbage(t *testing.T) {
	...
	if _, ok := decodeKnowledgePageFromBody("<!--hivex-knowledge-b64:%%%notb64%%%-->"); ok {
...
func TestAppKnowledgeScopeTagRoundTrip(t *testing.T) {
	...
	if tag != "hivex-app-d50e34194a87a5ed" {
	...
	if _, ok := appIDFromScopeTag(appKnowledgeTag); ok {
		t.Fatalf("hivex-app-knowledge must not resolve to an app id")
	}
}
...
func TestAppScopeTagsHelpers(t *testing.T) {
	tags := []string{
		"hivex-app-knowledge",
		"hivex-app-d50e34194a87a5ed",
		"hivex-app-aaaa1111bbbb2222",
		"office",
	}
	...
	merged := mergeScopeTags(
		[]string{"hivex-app-d50e34194a87a5ed"},
		[]string{"hivex-app-d50e34194a87a5ed", "hivex-app-cccc3333dddd4444", "office"},
	)
	if len(merged) != 2 {
