...
func (l *Lint) judgeCluster(ctx context.Context, entitySlug, subject, predicate string, cluster []TypedFact) (bool, string, error) {
	...
	systemPrompt := "You are the hivebot lint judge. Given a cluster of facts sharing (subject, predicate), determine if there is a real semantic contradiction. Read docs/specs/WIKI-SCHEMA.md §10.4 rules: temporal validity, specificity, and paraphrase are NOT contradictions. Real contradictions are currently-valid, mutually-exclusive claims."
...
func formatLintReport(report LintReport) string {
	...
	sb.WriteString("Generated by the hivebot archivist lint runner. Source: wiki fact logs and graph.log.\n")
