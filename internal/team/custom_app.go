...
// <runtime-home>/.hivex/apps/<id>/ and renders inside a sandboxed iframe.
//
...
// CustomAppsRootDir returns <runtime-home>/.hivex/apps, honouring
...
func CustomAppsRootDir() string {
	...
	if home == "" {
		return filepath.Join(".hivex", "apps")
	}
	return filepath.Join(home, ".hivex", "apps")
}
