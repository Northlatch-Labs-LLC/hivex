...
func (b *Broker) StartOnPort(port int) error {
	...
	mux.HandleFunc("/custom-providers", b.requireAuth(b.handleCustomProviders))
	mux.HandleFunc("/custom-providers/add", b.requireAuth(b.handleCustomProviderAdd))
	mux.HandleFunc("/custom-providers/update", b.requireAuth(b.handleCustomProviderUpdate))
