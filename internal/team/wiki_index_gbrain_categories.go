...
//
//	articles/<b64(path)> --hivex_category--> categories/<slug>
//	categories/<child>   --hivex_parent_category--> categories/<parent>
//
...
func (s *gbrainFactStore) ensureCategoryPage(ctx context.Context, category string) error {
	...
	fm := map[string]string{"type": "concept", "hivex_category": category}
...
func (s *gbrainFactStore) ensureArticlePage(ctx context.Context, articlePath string) error {
	...
	fm := map[string]string{"type": "note", "hivex_article_path": articlePath}
