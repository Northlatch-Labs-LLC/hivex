...
type teamTask struct {
	...
	// (`hivex task review --invite <slug>`) appends tunnel-human slugs to
...
type officeMember struct {
	...
	// cloud provider; "" means box. See docs/specs/hivebot-bot-computers.md.
...
type teamSkill struct {
	...
	// metadata.hivex.source_articles[0] in the rendered SKILL.md and as
