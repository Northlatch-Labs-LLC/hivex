...
// wiki_gbrain_page_render.go — renders hivebot entities as gbrain's RECOMMENDED
...
// ================================
// hivebot cites individual facts (SearchHit.FactID), but gbrain retrieves pages
...
// `hivex_facts`. gbrain's page-size sanity check counts only
...
// gbrain's MECE directories, by hivebot entity kind. Filing every entity under
...
const gbrainFactsBlobKey = "hivex_facts"
...
// entityDirForKind maps a hivebot entity kind onto its primary-home directory.
...
// pageTypeForKind maps a hivebot kind onto gbrain's page-type vocabulary.
...
//
// This is what converts a gbrain chunk hit back into hivebot fact citations. A
