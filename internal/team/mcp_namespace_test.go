...
// buildMCPServerMap or the opencode wiring back to a bare "hivex-office"
...
func TestBuildMCPServerMapRegistersEveryLegacyKey(t *testing.T) {
	const legacy = "hivex-office-legacy-probe"
...
func TestBotMCPServersReturnsEveryLegacyKey(t *testing.T) {
	...
	t.Setenv("HIVEX_CHANNEL", DMSlugFor("cos"))
	dm := botMCPServers("pm")
	...
	t.Setenv("HIVEX_CHANNEL", "product")
