...
// office_eval_jobs_loop.go — eval jobs for the core-loop build phases
// (B1 completion hook onward) and the post-v2-eval fix lane. The harness,
// fixture, and the earlier substrate jobs live in office_eval.go; the
// job registry there names every job in both files.
