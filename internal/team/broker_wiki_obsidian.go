...
//
// Disabled via HIVEX_OBSIDIAN_WATCHER=0 (off) for operators who want to
...
// (a) the worker is up, (b) HIVEX_OBSIDIAN_WATCHER is not "0"/"off"/"false".
...
func obsidianWatcherEnabled() bool {
	switch strings.ToLower(strings.TrimSpace(os.Getenv("HIVEX_OBSIDIAN_WATCHER"))) {
