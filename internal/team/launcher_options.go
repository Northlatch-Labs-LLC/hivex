...
// the channel TUI / cmd/hivebot use (BrokerToken, OneOnOneBot).
...
// for cmd/hivebot/main.go and tests; thin delegator over the targeter.
...
// cmd/hivebot/main.go to wire workspace orchestration after launch.
