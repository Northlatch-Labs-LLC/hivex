...
func TestIntrospectAppSource(t *testing.T) {
	files := map[string]string{
		"package.json":        "{}",
		"src/hivex-bridge.ts": "export function getEmails(){} // protected: must be skipped",
		"src/App.tsx": `
...
func TestIntrospectCallIntegrationAndWrites(t *testing.T) {
	files := map[string]string{
		"src/App.tsx": `
import { callIntegration, createTask } from "./hivex-bridge";
