...
//
// WHY THIS EXISTS, AND WHY IT STILL SAYS ".hivex".
//
...
// files build their own path with filepath.Join(home, ".hivex", ...) rather
...
// among them. Flipping the name here while those still say ".hivex" would not
...
var LegacyRuntimeDirNames = []string{".hive"}
