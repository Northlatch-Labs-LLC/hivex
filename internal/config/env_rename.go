...
// HIVEX_X to GAWKBOT_X in the source does not rename it in a customer's CI: it
...
const EnvPrefix = "HIVEX_"

// LegacyEnvPrefixes are prefixes this runtime used to use, NEWEST FIRST.
//
// The rename adds the new prefix as EnvPrefix and moves "HIVEX_" to the front
...
// generation ("HIVEX_RUNTIME_HOME", "<LEGACY>_RUNTIME_HOME") — the prefix is
