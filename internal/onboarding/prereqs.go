...
type PrereqResult struct {
	...
	// Required is true when hivex cannot function without this binary.
...
// CLI runtimes must be present for hivex to actually run a turn, but all are
...
// 5s client deadline at cmd/hivebot/onboarding.go; running probes serially
