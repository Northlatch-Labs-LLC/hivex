...
// WikiSchema. It is the Lane B half of hivebot's LLM Wiki v1: Lane A owns
// the actual git repo at ~/.hivex/wiki/; this file just writes files
...
// for schema inside wikiRoot (typically ~/.hivex/wiki). It is
