	...
	tests := []struct {
	...
	}{
		{
			...
			input: func(wikiRoot string) CompanySeedInput {
				return CompanySeedInput{
					...
					WikiRoot:  wikiRoot,
					FilePaths: []string{mustTempFile("hivex-seed-*.txt", "Acme is a B2B SaaS company.")},
				}
			},
		...
		},
		{
			...
			input: func(wikiRoot string) CompanySeedInput {
				...
				return CompanySeedInput{
					...
					WikiRoot:  wikiRoot,
					FilePaths: []string{mustTempFile("hivex-seed-*.txt", "Acme builds software.")},
				}
			},
			wantRealCompanyMD: true,
			wantReadme:        true,
		...
		},
		{
			...
			input: func(wikiRoot string) CompanySeedInput {
				return CompanySeedInput{
					Completer: mockCompleter{response: validJSON},
					WikiRoot:  wikiRoot,
					FilePaths: []string{mustTempFile("hivex-seed-*.txt", "Some company content.")},
				}
			},
			wantReadme:        true,
			wantRealCompanyMD: true,
		...
		},
		{
			...
			input: func(wikiRoot string) CompanySeedInput {
				return CompanySeedInput{
					WikiRoot:  wikiRoot,
					FilePaths: []string{mustTempFile("hivex-seed-*.pdf", "%PDF fake")},
				}
			},
			wantReadme:          true,
