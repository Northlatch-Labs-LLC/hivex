...
const MCPURLEnv = "HIVEX_GBRAIN_MCP_URL"
...
// overriding the HIVEX_GBRAIN_MCP_URL env var.
...
// NewClient builds a gbrain MCP client. When HIVEX_GBRAIN_MCP_URL is set (and
...
// provenance tag (e.g. "hivex-capture") — gbrain rejects its reconciliation-
