...
//
//	HIVEX_COMPUTER_LIVE=1 go test ./internal/computer -run TestLiveContainerLifecycle -v
func TestLiveContainerLifecycle(t *testing.T) {
	if os.Getenv("HIVEX_COMPUTER_LIVE") != "1" {
		t.Skip("set HIVEX_COMPUTER_LIVE=1 to run against a real container runtime")
	}
