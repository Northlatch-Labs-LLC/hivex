...
func TestRenderArticleIncludesProvenanceHeader(t *testing.T) {
	...
	if !strings.Contains(got, "Imported from hive") {
...
func TestMigratorDryRunSkipsCommit(t *testing.T) {
	...
	adapter := &fixedAdapter{records: []MigrationRecord{
		{Kind: KindPeople, Slug: "nazz", Title: "Nazz", Content: "founder", Source: "hive"},
	}}
...
func TestMigratorSkipsIdenticalContent(t *testing.T) {
	...
	rec := MigrationRecord{Kind: KindPeople, Slug: "nazz", Title: "Nazz", Content: "founder", Source: "hive"}
...
func TestMigratorRespectsLimit(t *testing.T) {
	...
	records := []MigrationRecord{
		{Kind: KindPeople, Slug: "a", Title: "A", Content: "a", Source: "hive"},
		{Kind: KindPeople, Slug: "b", Title: "B", Content: "b", Source: "hive"},
		{Kind: KindPeople, Slug: "c", Title: "C", Content: "c", Source: "hive"},
	}
...
func TestMigratorIntegrationWithWikiWorker(t *testing.T) {
	...
	if !strings.Contains(out, "migrate <migrate@hivex.local>") {
