...
/// code carrying `hivebot://pair?url=<broker>&token=<token>`. The same fields
...
public struct Pairing: Equatable, Sendable {
    ...
    public static let scheme = "hivebot"

    /// Parses a pairing link. Accepts `hivebot://pair?url=…&token=…` and a
