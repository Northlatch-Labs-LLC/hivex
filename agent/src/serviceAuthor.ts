...
// rather than a network guess. This is what makes "teach Hive a tool" REAL on a
...
/**
 * Resolve the engine for RUNTIME `hive.ai.*` capabilities (summarize/score/write
 ...
 * hive.ai.* stays honestly simulated rather than throwing.
 */
