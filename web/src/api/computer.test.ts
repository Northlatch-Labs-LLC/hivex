...
describe("computer api", () => {
  ...
  it("fetches and normalises a per-bot status", async () => {
    vi.spyOn(client, "get").mockResolvedValue({
      ...
      container_name: "hivebot-computer-abc",
      workspace_dir: "/home/you/.hivebot/computers/abc",
      box: null,
    });
    ...
    expect(status.containerName).toBe("hivebot-computer-abc");
