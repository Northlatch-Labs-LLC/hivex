 ...
 * with hivebot-specific rules layered on so the editor's HTML serialises back to
...
function createTurndown(): TurndownService {
  ...
  // misread as links. That would mangle two hivebot shapes we deliberately keep
