  ...
  banners: [
    {
      ...
      message:
        "Slot filled with skipped placeholder. Merge anyway, or rerequest with `hivebot task review task-2741 --rerequest sam`.",
      reviewerSlug: "sam",
      elapsed: "10m",
    },
  ],
 ...
 * `~/.hivex/tasks/<id>/decision_packet.json` source.
 */
