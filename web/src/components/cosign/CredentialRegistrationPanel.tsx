...
import type { ApprovalRole } from "@hivex/protocol";
...
const WEBAUTHN_UNSUPPORTED_MESSAGE =
  "This environment doesn't support passkeys (WebAuthn), so a security key can't be registered here. Open hivebot in a browser or on a platform with passkey support to bind an approval credential.";
