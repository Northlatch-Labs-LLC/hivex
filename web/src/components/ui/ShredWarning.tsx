...
// `internal/workspace/workspace.go:Shred` removes the entire `~/.hivex/office`
...
export function ShredDeletionsList() {
  return (
    <>
      <li>
        Onboarding flag (<code>~/.hivex/onboarded.json</code>) so the wizard
        reopens
      </li>
      <li>
        Company identity (<code>~/.hivex/company.json</code>)
      </li>
      <li>
        Team runtime state, office, and workflows under <code>~/.hivex/</code>
      </li>
      <li>
