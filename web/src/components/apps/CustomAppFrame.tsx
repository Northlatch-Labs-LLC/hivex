...
/**
 * Validate + cap an inbound "hivex-select" payload into the host's trusted
...
/** Validate + cap an inbound "hivex-error" payload. Pure for unit tests. */
 ...
 * (`hivex-select` / `hivex-error`) to display-only callbacks. Keyed on devUrl
