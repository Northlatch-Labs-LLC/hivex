...
//     (OpenClaw, Hermes). The bot's runtime is gateway-managed; hivebot
...
export const INTEGRATION_CATEGORIES: readonly IntegrationCategoryMeta[] = [
  {
    ...
    title: "External Bots",
    description:
      "Gateways that import bots from another system into the team. The imported bot's runtime is managed by the gateway, not hivebot.",
  },
  {
    id: "channels",
    title: "Channels",
