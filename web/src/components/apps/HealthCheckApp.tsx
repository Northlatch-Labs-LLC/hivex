...
/**
 * Pair your phone: a QR code the hivebot iOS app scans. Host-only, because
      ...
      {!isHost ? (
        ...
        <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
          {dataURL ? (
            <img
              src={dataURL}
              alt="Pairing code for the hivebot iOS app"
              width={120}
              height={120}
          ...
          <div className="app-card-meta" style={{ lineHeight: 1.4 }}>
            Open hivebot on your iPhone and scan this. The phone must reach this
...
function useTunnelControls(isHost: boolean) {
  ...
  const startTunnelInvite = () => {
    ...
    confirm({
      ...
      message:
        "This opens a Cloudflare Quick Tunnel that publishes your hivebot web UI on the public internet so a teammate can join from any browser.",
      details: (
        <ul>
          <li>
