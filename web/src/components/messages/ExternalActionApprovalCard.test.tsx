...
describe("<ExternalActionApprovalCard>", () => {
  it("shows the integration, verb, action id, payload, and account", () => {
    ...
    expect(screen.getByText("alex@northlatch.example")).toBeInTheDocument();
    expect(
