...
const SILENT_UP_TO_KEY = "hivex-upgrade-silent-up-to";
...
function UpgradeRunOutcome({
  ...
  if (result.ok) {
    ...
    // the hivebot service. The user has to do that themselves (Ctrl+C in
    // their terminal, then `hivebot` again). Promise only what the click
    ...
    return (
      <div className="upgrade-banner-outcome upgrade-banner-outcome--ok">
        <span>
          Installed v{latest}. Reload this page after restarting hivex.
        </span>
