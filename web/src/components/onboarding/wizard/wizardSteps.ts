 ...
 *
 * All copy is hivebot voice: no em-dashes, no contractions, Oxford comma, dry
...
/**
 * The prefilled first-issue example. RevOps framing: hivebot operates on the
 ...
 * strings are hivebot voice. Verbatim source of truth for the step screens.
 */
...
> = {
  meet: {
    ...
    headline: "Meet hivebot.",
    body: "hivebot is a team of AI bots that work on your behalf. They claim work, they ship, and they actually answer your messages. Watch your team assemble itself on the right.",
  },
  wiki: {
 ...
 * source of truth. hivebot voice: no contractions, no em-dashes, Oxford comma.
 */
export const ONBOARDING_EMAIL_COPY = {
  ...
  hint: "Optional. We use it to keep you posted on hivebot, and nothing else.",
  /**
  ...
  consent:
    "Keep me posted on hivebot. It is source-available and built in the open, and we would love to learn what to build next. No spam, we promise.",
} as const;
 ...
 * hivebot voice: no contractions, no em-dashes, Oxford comma. Single source of
...
export const ONBOARDING_COMPUTER_COPY = {
  ...
  cloudNote:
    "A cloud box is a persistent Linux desktop that keeps its files and logins between sessions. It runs on your own ascii.dev account, which needs a plan or the 7-day trial; you pay ascii.dev directly and hivebot never sees a bill.",
  ...
  signinProvisioning: "Signed in. Creating a key named hivebot for you…",
  signinCliMissing:
...
/** UI chrome labels for the wizard host. hivebot voice, no contractions. */
