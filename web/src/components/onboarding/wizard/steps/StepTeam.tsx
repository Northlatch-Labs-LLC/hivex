        ...
        >
          ...
          >
            ...
            <span className="onboarding-pack-card-body">
              ...
              <span className="onboarding-pack-card-desc">
                Skip the packs. hivebot stands up a small founding team and you
                grow it from there.
              </span>
          ...
          {mounted === SCRATCH_KEY ? (
            <PackDrawer id="pack-drawer-scratch" open={open}>
              <div className="onboarding-pack-team onboarding-pack-team--inline">
                <p className="onboarding-pack-team-hint">
                  Starting from scratch. hivebot will stand up a Chief of Staff
                  and a small founding team. Add a custom agent below, or grow
                  the team later from the office.
                </p>
              </div>
            </PackDrawer>
          ) : null}
