 ...
 *    browser sign-in, mints a key named hivebot, verifies it, and stores it,
      ...
      <div className="office-tour-slide-stage office-tour-slide-stage--computer">
        <picture>
          ...
          <img
            ...
            width={640}
            height={402}
            alt="The Computer tab of a hivebot: its own Linux desktop, where Firefox opens and loads example.com while the bot works."
            loading="lazy"
            decoding="async"
          />
        </picture>
