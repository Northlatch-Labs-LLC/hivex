/**
 * StepMeet — wizard step 01, "Meet hivebot."
 *
 * Sets the metaphor: hivebot is an office, and a team of bots lives in it. The
 ...
 * meet-office.gif): a "hivebot · office" window where the founding team comes
      ...
      <div className="office-tour-slide-stage office-tour-slide-stage--intro">
        <picture>
          ...
          <img
            ...
            width={868}
            height={620}
            alt="A hivebot office coming online: the Chief of Staff who runs the team, @revops who keeps the CRM clean, and @analyst who watches the funnel, each turning to an online presence as they arrive."
            loading="lazy"
            decoding="async"
          />
        </picture>
