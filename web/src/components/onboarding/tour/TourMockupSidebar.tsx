/**
 * TourMockupSidebar — a decorative, non-interactive mock of hivebot's real left
 ...
 *
 * All colors come from design tokens; the component renders in hive, hive-dark,
  ...
  return (
    <aside className="tour-mockup-sidebar" aria-hidden="true">
      <header className="tour-mockup-header">
        <span className="tour-mockup-logo">hivebot</span>
      </header>
