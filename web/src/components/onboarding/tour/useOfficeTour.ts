 ...
 *     localStorage key `hivex.office-tour-done`.
 *   - Re-openable on demand (a Help entry, a keyboard shortcut) via a
 *     window CustomEvent `hivex:show-office-tour`. `requestShowOfficeTour()`
...
export const OFFICE_TOUR_DONE_KEY = "hivex.office-tour-done";

/** Window event that re-opens the tour (replay). */
export const OFFICE_TOUR_SHOW_EVENT = "hivex:show-office-tour";
