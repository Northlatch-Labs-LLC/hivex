 ...
 * satisfy. Everything the ported editor needs that hivebot owns flows through
...
export interface RefcloneEditorContextValue {
   ...
   * hivebot's POST /wiki/upload (uploadWikiFile) + wikiFileUrl.
   */
   ...
   * thumbnail in the folder index). The wrapper wires this to hivebot's
...
/**
 * Provider that bridges hivebot props into the ported editor's Zustand store
