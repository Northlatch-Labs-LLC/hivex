...
// (fixed vs reverted) and passes HIVEX_SHOT_LABEL so the before/after PNGs
// land side by side in one orphan branch:
//
//   HIVEX_SHOT_LABEL=01-before  (classifier reverted to origin/main)
//   HIVEX_SHOT_LABEL=02-after   (classifier fixed)
...
const LABEL = process.env.HIVEX_SHOT_LABEL ?? "routines";
