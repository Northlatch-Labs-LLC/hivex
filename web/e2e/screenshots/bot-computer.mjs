...
const CONFIG = () => ({
  ...
  config_path: "/Users/you/.hivex/config.json",
...
const STATUS = () => ({
  ...
  container_name: "hivebot-computer-3f2a9c1b7d4e6f08",
  workspace_dir: "~/.hivebot/computers/3f2a9c1b7d4e6f08",
  box: null,
});
...
const RUNTIME = () => ({
  ...
  image_ref: "hivebot/computer:cua-0.20.0",
...
async function setTheme(id) {
  await page.evaluate(async (theme) => {
    ...
    const existing = document.getElementById("hivex-theme-shot");
    if (existing) existing.remove();
    const link = document.createElement("link");
    link.id = "hivex-theme-shot";
    link.rel = "stylesheet";
