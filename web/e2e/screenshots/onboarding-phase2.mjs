...
//   2. Setting the localStorage flag hivex:onboarding-v2=1
//   3. Setting hivex:in-ceo-onboarding=1 (NEW flag checked by RootRoute
...
async function bootPhase2(page) {
  ...
  await page.addInitScript(() => {
    try {
      window.localStorage.setItem("hivex:onboarding-v2", "1");
      ...
      window.localStorage.setItem("hivex:in-ceo-onboarding", "1");
    } catch {
