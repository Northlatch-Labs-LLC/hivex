...
//   BASE_URL=http://localhost:5273 HIVEX_SCREENSHOTS_OUT=/tmp/obsidian-shots \
...
if (!OUT) {
  console.error("HIVEX_SCREENSHOTS_OUT is not set; run via publish.sh or set it manually");
  process.exit(2);
}
