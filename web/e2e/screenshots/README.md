...
specs against a real `hivex` binary for smoke testing. The harness here
...
#    - runs the spec, writing PNGs to /tmp/hivex-screenshots-<feature>/
...
`$HIVEX_SCREENSHOTS_OUT` (the wrapper sets this).
