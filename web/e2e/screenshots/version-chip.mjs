...
//
// The wrapper boots vite, sets HIVEX_SCREENSHOTS_OUT, runs this file,
...
if (!OUT) {
  console.error("HIVEX_SCREENSHOTS_OUT is not set; run via publish.sh");
  process.exit(2);
}
...
const UP_TO_DATE = {
  ...
  is_dev_build: false,
  upgrade_command: "npm install -g hivex@latest",
  install_method: "global",
  install_command: "npm install -g hivex@latest",
};
...
const OUTDATED = {
  ...
  install_method: "global",
  install_command: "npm install -g hivex@latest",
  compare_url: "https://github.com/Northlatch-Labs-LLC/hivebot/compare/v0.83.5...v0.84.0",
};
...
await installCommonMocks(context, {
  ...
  upgradeRun: {
    ...
    command: "npm install -g hivex@latest",
    error:
      "EACCES: permission denied, mkdir '/usr/local/lib/node_modules/hivex'",
    output:
      "npm error code EACCES\nnpm error syscall mkdir\nnpm error path /usr/local/lib/node_modules/hivex\nnpm error errno -13\n",
  },
});
await bootShell(page, { afterFlipSelector: ".status-bar-version" });
await page.locator(".status-bar-version").click();
