...
// `hivebot workspace create <name>` — allocate ports, spawn broker, register.
//
...
func runWorkspaceCreate(args []string) {
	...
	fs.Usage = func() {
		fmt.Fprintln(os.Stderr, "hivebot workspace create — spawn a new workspace")
		fmt.Fprintln(os.Stderr, "")
		fmt.Fprintln(os.Stderr, "Usage:")
		fmt.Fprintln(os.Stderr, "  hivebot workspace create <name>")
		fmt.Fprintln(os.Stderr, "  hivebot workspace create --blueprint=founding-team demo-launch")
		fmt.Fprintln(os.Stderr, "  hivebot workspace create --from-scratch scratchpad")
		fmt.Fprintln(os.Stderr, "")
