...
// for the hivebot "channel" TUI surface — broker-shape data types, slug-
...
// consume.
//
// The package lives under cmd/hivebot/ rather than internal/ because it is
...
//     channelui — those stay in package main where the hivex TUI
...
//     ChannelCrashLogPath (~/.hivex/logs/channel-crash.log with
...
//     "" for empty / "null"), TaskLogRoot (HIVEX_TASK_LOG_ROOT
//     env var → ~/.hivex/office/tasks → ".hivex/office/tasks"
