...
import (
	...
	"github.com/Northlatch-Labs-LLC/hivex/bench/slice-1/runner"
)
...
func main() {
	var (
		...
		backend = flag.String("backend", "sqlite", "index backend under test: sqlite|gbrain|gbrain-atoms|memory")
	)
	flag.Parse()
