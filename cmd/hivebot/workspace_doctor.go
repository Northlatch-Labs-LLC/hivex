...
// `hivebot workspace doctor` — reconcile registry vs. reality, prompt to fix.
//
...
func runWorkspaceDoctor(args []string) {
	...
	fs.Usage = func() {
		fmt.Fprintln(os.Stderr, "hivebot workspace doctor — reconcile workspace registry against reality")
		fmt.Fprintln(os.Stderr, "")
		fmt.Fprintln(os.Stderr, "Usage:")
		fmt.Fprintln(os.Stderr, "  hivebot workspace doctor             Interactive: prompt y/N per issue")
		fmt.Fprintln(os.Stderr, "  hivebot workspace doctor --dry-run   Report issues, never prompt or fix")
		fmt.Fprintln(os.Stderr, "  hivebot workspace doctor --yes       Apply every fix without prompting")
		fmt.Fprintln(os.Stderr, "")
