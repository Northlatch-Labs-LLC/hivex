...
func (m channelModel) buildOfficeIntroLines(contentWidth int) []channelui.RenderedLine {
	...
	title := channelui.SubtlePill("office", "#F8FAFC", "#1264A3") + " " + lipgloss.NewStyle().Bold(true).Render("hivebot")
	body := "Welcome to hivebot. Live coordination across rooms, direct sessions, tasks, and decisions. Everyone can see everything, which is the entire point."
	extra := []string{
