...
import (
	...
	"github.com/Northlatch-Labs-LLC/hivex/internal/avatar"
)
...
// helpers so adding a new built-in role only requires editing the
// canonical slug list and the DisplayName/RoleLabel switches.
