...
// `hivebot workspace resume <name>` — spawn the broker, wait for port-bind.
//
...
func runWorkspaceResume(args []string) {
	...
	fs.Usage = func() {
		fmt.Fprintln(os.Stderr, "hivebot workspace resume — restart a paused workspace")
		fmt.Fprintln(os.Stderr, "")
		fmt.Fprintln(os.Stderr, "Usage:")
		fmt.Fprintln(os.Stderr, "  hivebot workspace resume <name>")
		fmt.Fprintln(os.Stderr, "")
