...
// TestUpgradeJSONOutput locks the wire shape that `hivebot upgrade --json`
// emits. Catches:
...
func TestUpgradeJSONOutput(t *testing.T) {
	res := upgradecheck.Result{
		...
		IsDevBuild:       false,
		CompareURL:       "https://github.com/Northlatch-Labs-LLC/hivex/compare/v0.79.10...v0.79.15",
		UpgradeCommand:   "npm install -g hivebot@latest",
	}
