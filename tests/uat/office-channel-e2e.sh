...
termwright daemon --socket "$SOCKET" --cols 120 --rows 40 --background -- "$BINARY" --no-hive --channel-view --channel-app messages
sleep 5

assert_contains "The HIVEX swarm" "boot"
