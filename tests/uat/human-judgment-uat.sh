#!/bin/bash
# Human Judgment UAT Test Suite for hivex TUI
...
cd "$ROOT" && go build -o hivex ./cmd/hivebot 2>&1
echo "Build complete."
echo ""
...
#   "I just installed hivex. What am I looking at?"
# ═══════════════════════════════════════════════════════════════════════
CURRENT_P=1
echo ""
...
if assert_screen_not_blank "m1" && assert_text "The HIVEX swarm|Welcome to The HIVEX swarm" "m1" && assert_text "Message #general" "m1" && assert_readable "m1-boot"; then pass; else fail; fi
