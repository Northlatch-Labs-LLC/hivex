...
//
// The chain semantics:
//   GENESIS_PREV_HASH = sha256("hivex:audit:genesis:v1")  (domain-separated;
...
export const PAYLOAD_KIND_METADATA = {
  receipt_created: {
    ...
    bodySchemaRef: "hivex.audit.payload.receipt_created.v1",
  },
  receipt_updated: {
    description: "Receipt snapshot changed before finalization.",
    bodySchemaRef: "hivex.audit.payload.receipt_updated.v1",
  },
  receipt_finalized: {
    description: "Receipt reached a terminal status.",
    bodySchemaRef: "hivex.audit.payload.receipt_finalized.v1",
  },
  approval_requested: {
    description: "A write approval request was presented.",
    bodySchemaRef: "hivex.audit.payload.approval_requested.v1",
  },
  approval_decided: {
    description: "A reviewer accepted, rejected, or abstained on an approval.",
    bodySchemaRef: "hivex.audit.payload.approval_decided.v1",
  },
  cost_event: {
    description: "Token or cost accounting changed.",
    bodySchemaRef: "hivex.audit.payload.cost_event.v1",
  },
  budget_set: {
    description: "A cost budget was created, updated, or tombstoned.",
    bodySchemaRef: "hivex.audit.payload.budget_set.v1",
  },
  budget_threshold_crossed: {
    description: "Cumulative spend crossed a configured budget threshold.",
    bodySchemaRef: "hivex.audit.payload.budget_threshold_crossed.v1",
  },
  tool_call_started: {
    description: "A tool invocation began.",
    bodySchemaRef: "hivex.audit.payload.tool_call_started.v1",
  },
  tool_call_completed: {
    description: "A tool invocation completed.",
    bodySchemaRef: "hivex.audit.payload.tool_call_completed.v1",
  },
  external_write_proposed: {
    description: "An external write diff was proposed.",
    bodySchemaRef: "hivex.audit.payload.external_write_proposed.v1",
  },
  external_write_applied: {
    description: "An external write was applied and verified.",
    bodySchemaRef: "hivex.audit.payload.external_write_applied.v1",
  },
  external_write_failed: {
    description: "An external write failed, partially applied, or rolled back.",
    bodySchemaRef: "hivex.audit.payload.external_write_failed.v1",
  },
  thread_created: {
    description: "A thread was created.",
    bodySchemaRef: "hivex.audit.payload.thread_created.v1",
  },
  thread_spec_edited: {
    description: "A thread spec revision was accepted.",
    bodySchemaRef: "hivex.audit.payload.thread_spec_edited.v1",
  },
  thread_status_changed: {
    description: "A thread status transition was accepted.",
    bodySchemaRef: "hivex.audit.payload.thread_status_changed.v1",
  },
  boot_marker: {
    description: "The broker appended a startup marker.",
    bodySchemaRef: "hivex.audit.payload.boot_marker.v1",
  },
  merkle_root: {
    description: "A signed Merkle root checkpoint was emitted.",
    bodySchemaRef: "hivex.audit.payload.merkle_root.v1",
  },
...
/**
 * Genesis chain anchor: sha256("hivex:audit:genesis:v1"), NOT the RFC sketch's
 * literal sha256("genesis"). Cross-language verifiers MUST hash that exact
 * domain-separated byte sequence.
 */
export const GENESIS_PREV_HASH = sha256Hex("hivex:audit:genesis:v1");
