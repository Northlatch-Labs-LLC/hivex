...
const CREDENTIAL_HANDLE_CONSTRUCTOR_SECRET = Symbol("hivex.credential-handle.constructor");
const BROKER_IDENTITY_CONSTRUCTOR_SECRET = Symbol("hivex.broker-identity.constructor");
...
export function createBrokerIdentityForTesting(input: {
  ...
  return new BrokerIdentity(BROKER_IDENTITY_CONSTRUCTOR_SECRET, {
    ...
    revocationToken: input.revocationToken ?? Symbol("hivex.broker-identity.testing"),
  });
}
